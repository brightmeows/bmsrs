...
use bms_tokenizer::{
    ArgbParams, AtBgaParams, BgaParams, BmpTag, BmsChannelId, BmsHeaderResDefVisual, ExBmpParams,
...
pub struct Visual {
    ...
    pub ex_bmp_defs: BTreeMap<BmsChannelId<BmpTag>, OwnedExBmpParams>,
    /// BGA crop-and-place definitions (`#BGAxx`).
    pub crop_defs: BTreeMap<BmsChannelId<BmpTag>, BgaParams>,
    /// BGA crop-and-place (width/height form) (`#@BGAxx`).
    pub alt_crop_defs: BTreeMap<BmsChannelId<BmpTag>, AtBgaParams>,
    /// Key-bound BGA animation definitions (`#SWBGAxx`).
    pub sw_bga_defs: BTreeMap<BmsChannelId<BmpTag>, OwnedSwBgaParams>,
    /// Per-layer colour / alpha overlay definitions (`#ARGBxx`).
    pub argb_defs: BTreeMap<BmsChannelId<BmpTag>, ArgbParams>,
